...
from vllm_ascend.patch_cmss.distributed.kv_transfer.kv_p2p.mooncake_hybrid_connector import (  # noqa: E402
    apply as apply_cmss_mooncake_patch,
)

apply_cmss_mooncake_patch()
