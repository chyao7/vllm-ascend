...
def split_qkv_tp_rmsnorm_rope_cache_impl(
    input: torch.Tensor,
    q_weight: torch.Tensor,
    k_weight: torch.Tensor,
    q_hidden_size: int,
...
def split_qkv_tp_rmsnorm_rope_cache_impl_fake(
    input: torch.Tensor,
    q_weight: torch.Tensor,
    k_weight: torch.Tensor,
    q_hidden_size: int,
    ...
    return torch.empty(input.shape[0], q_hidden_size, device=input.device, dtype=input.dtype)
...
direct_register_custom_op(
    op_name="split_qkv_tp_rmsnorm_rope_cache",
    op_func=split_qkv_tp_rmsnorm_rope_cache_impl,
    fake_impl=split_qkv_tp_rmsnorm_rope_cache_impl_fake,
