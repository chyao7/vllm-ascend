...
/*!
 * \file test_aclnn_int8_sparse_flash_attention.cpp
 * \brief
 */
...
int32_t ExecuteInt8SparseFlashAttention(TensorResources& resources, aclrtStream stream, 
    ...
    int32_t ret = aclnnInt8SparseFlashAttentionGetWorkspaceSize(resources.queryTensor, resources.keyTensor, resources.valueTensor, resources.sparseIndicesTensor, nullptr, nullptr, nullptr, resources.queryRopeTensor, resources.keyRopeTensor,
                                                    scaleValue, sparseBlockSize, layoutQuery, layoutKv, sparseMode, preTokens,
                                                    nextTokens, attentionMode, returnSoftmaxLse, keyScale, keyOffset, resources.attentionOutTensor, resources.softmaxMaxTensor, resources.softmaxSumTensor, workspaceSize, &executor);
    if (!CHECK_RET(ret == ACL_SUCCESS)) {
