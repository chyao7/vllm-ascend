...
/*!
 * \file int8_sparse_flash_attention_template_tiling_key.h
 * \brief
 */

#ifndef INT8_SPARSE_FLASH_ATTENTION_TEMPLATE_TILING_KEY_H
#define INT8_SPARSE_FLASH_ATTENTION_TEMPLATE_TILING_KEY_H
...
// 模板参数支持的范围定义
ASCENDC_TPL_ARGS_DECL(Int8SparseFlashAttention, // 算子OpType
