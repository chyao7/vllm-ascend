...
/*!
 * \file int8_sparse_flash_attention_service_cube_mla.h
 * \brief use 7 buffer for matmul l1, better pipeline
 */
#ifndef INT8_SPARSE_FLASH_ATTENTION_SERVICE_CUBE_MLA_H
#define INT8_SPARSE_FLASH_ATTENTION_SERVICE_CUBE_MLA_H
...
#endif // INT8_SPARSE_FLASH_ATTENTION_SERVICE_CUBE_MLA_H
