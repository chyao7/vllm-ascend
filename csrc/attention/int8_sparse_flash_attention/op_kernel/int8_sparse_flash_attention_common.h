...
/*!
 * \file int8_sparse_flash_attention_common.h
 * \brief
 */

#ifndef INT8_SPARSE_FLASH_ATTENTION_COMMON_H
#define INT8_SPARSE_FLASH_ATTENTION_COMMON_H
...
template <typename Q_T, typename KV_INT8_T, typename OUT_T, const bool FLASH_DECODE = false,
...
#endif // INT8_SPARSE_FLASH_ATTENTION_COMMON_H
