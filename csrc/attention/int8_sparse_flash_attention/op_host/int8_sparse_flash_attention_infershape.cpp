...
/*!
 * \file int8_sparse_flash_attention_proto.cpp
 * \brief
 */
...
ge::graphStatus InferShapeInt8SparseFlashAttention(gert::InferShapeContext *context)
{  
    OP_CHECK_IF(context == nullptr, OP_LOGE("Int8SparseFlashAttention", "InferShapeContext is nullptr"),
...
ge::graphStatus InferDataTypeInt8SparseFlashAttention(gert::InferDataTypeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE("Int8SparseFlashAttention", "InferShapeContext is nullptr"),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(Int8SparseFlashAttention)
    .InferShape(InferShapeInt8SparseFlashAttention)
    .InferDataType(InferDataTypeInt8SparseFlashAttention);
} // namespace ops
