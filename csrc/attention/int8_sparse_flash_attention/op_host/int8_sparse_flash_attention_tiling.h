...
/*!
 * \file int8_sparse_flash_attention_tiling.h
 * \brief
 */
#ifndef INT8_SPARSE_FLASH_ATTENTION_TILING_H
#define INT8_SPARSE_FLASH_ATTENTION_TILING_H
...
constexpr uint32_t KEY_SCALE_ATTR_INDEX = 9;
constexpr uint32_t KEY_OFFSET_ATTR_INDEX = 10;
// Dim Num
...
struct SFAParaInfo {
    ...
    const float *kvDequantScale = nullptr;
    const float *kvDequantOffset = nullptr;
};
...
// -----------算子TilingData定义---------------
BEGIN_TILING_DATA_DEF(Int8SparseFlashAttentionBaseParamsMla)
...
TILING_DATA_FIELD_DEF(float, kvDequantScale)
TILING_DATA_FIELD_DEF(float, kvDequantOffset)
...
TILING_DATA_FIELD_DEF(uint32_t, kvStorageDim)
TILING_DATA_FIELD_DEF(uint32_t, keyQuantMode)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(Int8SparseFlashAttentionBaseParamsMlaOp, Int8SparseFlashAttentionBaseParamsMla)

BEGIN_TILING_DATA_DEF(Int8SparseFlashAttentionSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(Int8SparseFlashAttentionSingleCoreParamsMlaOp, Int8SparseFlashAttentionSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(Int8SparseFlashAttentionSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(Int8SparseFlashAttentionSingleCoreTensorSizeMlaOp, Int8SparseFlashAttentionSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(Int8SparseFlashAttentionSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(Int8SparseFlashAttentionSplitKVParamsMlaOp, Int8SparseFlashAttentionSplitKVParamsMla)

// 内切基本块参数
BEGIN_TILING_DATA_DEF(Int8SparseFlashAttentionInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(Int8SparseFlashAttentionInnerSplitParamsOp, Int8SparseFlashAttentionInnerSplitParams)

BEGIN_TILING_DATA_DEF(Int8SparseFlashAttentionTilingDataMla)
TILING_DATA_FIELD_DEF_STRUCT(Int8SparseFlashAttentionBaseParamsMla, baseParams);
TILING_DATA_FIELD_DEF_STRUCT(Int8SparseFlashAttentionSplitKVParamsMla, splitKVParams);
TILING_DATA_FIELD_DEF_STRUCT(Int8SparseFlashAttentionSingleCoreParamsMla, singleCoreParams);
TILING_DATA_FIELD_DEF_STRUCT(Int8SparseFlashAttentionSingleCoreTensorSizeMla, singleCoreTensorSize);
TILING_DATA_FIELD_DEF_STRUCT(Int8SparseFlashAttentionInnerSplitParams, innerSplitParams);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(Int8SparseFlashAttention, Int8SparseFlashAttentionTilingDataMla)
...
struct SFATilingInfo {
    ...
    uint32_t kvStorageDim = 512;
    uint32_t keyQuantMode = 0;
...
private:
    ...
    Int8SparseFlashAttentionTilingDataMla tilingData_;
...
public:
    ...
    ge::graphStatus GetKvStorageDim();
...
#endif // INT8_SPARSE_FLASH_ATTENTION_TILING_H
