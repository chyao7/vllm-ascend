...
extern "C" __global__ __aicore__ void mla_preprocess_merged_dtile(
    ...
    GM_ADDR kNopeClipAlpha, GM_ADDR q, GM_ADDR keycacheOut, GM_ADDR q2, GM_ADDR keycacheOut2, GM_ADDR innerOut,
...
extern void mla_preprocess_merged_dtile_impl(
    void* stream,
    void* hidden_state,
    void* quant_scale1,
    void* quant_offset1,
...
{
    mla_preprocess_merged_dtile<<<block_dim, nullptr, stream>>>(
        ...
        k_nope_clip_alpha, q, keycache_out, q2, keycache_out2, inner_out, workspace, tiling);
}
